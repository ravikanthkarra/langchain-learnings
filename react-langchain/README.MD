...
This branch (`project/react-langchain`) is a step-by-step tutorial demonstrating how to build an AI agent using the **ReAct (Reasoning + Acting) algorithm** with LangChain. Each commit represents a distinct stage in the implementation, allowing you to understand the architecture from the ground up.
...
### Commit 
### 1: Bootstrap LangChain ReAct Algorithm Environment
...
### 2: Add LangChain Tools and ReAct Prompt Template
...
### 3: Implement ReAct Agent Step with Tool Execution
...
### 4: Add ReAct Loop and CallbackHandler for Agent Execution
...
### 5: Switch from ReAct Prompting to Native Tool Calling
